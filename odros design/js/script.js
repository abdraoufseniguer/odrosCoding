$(document).ready(function(){
    ...
    customFile('.notifications .loadAnswer','load answer', '.custom-file:last-child');
    ...
    // add anouncement
    $(".ann button.add").click(function(){
        $(".ann").append("<div class='add-ann bg-color3 color-black px-3 py-3 my-4 row'><div class='add-ann-info col-md-9'><p>course name</p><p>05/04/2019</p></div><div class='add-ann-edit col-md-3'><button class='color-white'>Edit</button></div></div>");
    });
    // performances
   ...
   $(".close").click(function(e){
    ...
    $(".demands .demand .card .course-image .course-image-cover button.regect").click(function(){
        $(this).fadeOut(function(){
            $(this).siblings('.course-uns-bt').fadeOut(function () { 
                $(this).parent(".course-image-cover").append("<form action=''><textarea class='reg-exp'>here you will type the explanation</textarea><input type='submit' value='send'></form>");
             });
        });
    });
    ...
    $(".category-management button.adding-n-cat").click(function(){
        $(".categories").append("<div class='category my-5'><input type='text' value='Category Name'><i class='fas fa-pencil-alt color1'></i><a href='#'><i class='fas fa-times color-white'></i></a></div>");
    });
    $(".category-management .categories .category a i").click(function(e){
        e.preventDefault();
        $(this).parentsUntil('.category').hide(500);
    });
    $('.adding-attachment').on('click',function(){
        console.log('you clicked me');
        $('.course-attach').submit();
    });
