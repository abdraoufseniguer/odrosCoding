...
<head>
    ...
    <style>
        ...
        .allCourses .card .buy {z-index: 1000;}
        .allCourses .card .buy:hover .buy-overlay,
        .allCourses .card .buy:hover .buy-icon{
            display:block!important;  
            cursor: pointer;
        }
        .allCourses .card .buy-overlay {
            position: absolute;
            width: 100%;
            height: 100%;
            top: 0;
        ...
        .allCourses .progress{height: 0.2rem;}
        /* couses sample */
        /* navbar icons */
...
<body>
    ...
    <div class="allCourses">
        <div class="container">
            <!-- welcomming -->
            <h2 class="h1 color2 my-5 text-capitalize">all courses</h2>
            <!-- welcomming -->
            
            
            @foreach ($studentReservations->chunk(3) as $threeStdRes)
            <div class="row mb-5">
                @foreach ($threeStdRes as $stdRes)
                    <div class="col">
                        <div class="card" style="width: 18rem;">
                            <div class="buy p-rel">
                                <img class="card-img-top" src="{{asset('storage/images/student/courses/Rectangle 1.svg')}}" alt="Card image cap">
                                <div class="buy-overlay "></div>
                                <i class="fas fa-caret-right fa-5x color1 buy-icon"></i>
                            </div>
                            <div class="card-body">
                                <h5 class="card-title mb-4">{{$stdRes->course->course_name}}</h5>
                                <p class="card-text text-left text-capitalize text-muted">{{$stdRes->course->instructor->user->name}}</p>
                                <span class=" d-inline-block mr-2 text-capitalize">your progress :</span><span>80%</span>
                                <div class="progress rounded-0 my-4">
