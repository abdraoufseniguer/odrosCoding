                                        ...
                                        <div class="row">
                                            <div class="col-sm-5">
                                                <div class="card " style="width: 18rem;">
                                                    <img class="card-img-top" src="images/sample courses/Rectangle 1.svg" alt="Card image cap">
                                                    <div class="card-body">
                                                        <h5 class="card-title mb-4 color2 text-center">Here Goes The Name Of The course</h5>
                                                        <p class="card-text text-left text-capitalize text-muted">instructor name</p>
                                                        <!-- rating  -->
                                                        <div class="rate">
                                                        ...
                                                        <button class="btn btn-primary rounded mt-3 mx-auto">&dollar;20</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-7">
                                                <div class="goToCart text-capitalize text-center">
                                                    ...
                                                    <a href="#" class="color3 mt-4">go to cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="tab-content tab-content1 my-4" id="nav-tabContent">
            ...
            <div class="tab-pane fade color3 py-4 px-4" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                <div class="content py-4 px-4 color3 text-capitalize  course-requirement rounded">
                     ...
                     <ul class=" list-group">
                         <li class="group-item">you need a computer</li>
                         <li class="group-item">you have to know english</li>
                         <li class="group-item">a littel bit of html</li>
                         <li class="group-item">bootstrap</li>
                         <li class="group-item">css</li>
                     </ul>   
                </div>
            </div>
                ...
                <div class="content py-4 px-4 color3 text-capitalize  about-instructor rounded">
                    <div class="media text-captalize">
                        <div class="media-bare">
                            <img class="mr-5" src="images/courseDetails/Rectangle 47.png" alt="instructor image">
                        ...
                        <div class="media-body">
                            <h5 class="mt-0 color2">abderraouf seniguer</h5>
