...
@section('pageTitle','Admin / Student Management')
@section('pageStyle')
    <style>
...
@endsection
@section('headerLinks')
    <li class="list-inline-item color-white mx-5 active" data-crd=".cr-stat">student list  </li>
@endsection
@section('content')
   ...
   <div class="course-adiministration">
        <div class="container">
            <!-- search field -->
            <div class="search">
                <input type="text" value="Search Students">
                            ...
                            <div class="course">
                                <div class="card" style="width: 21rem;">
                                    <div class="course-image">
                                        <img class="card-img-top" src="{{asset('storage/images/admin/studentImage/course1.svg')}}" alt="Card image cap">
                                        <div class="course-image-cover">
                                            <button class="course-uns-bt conf popbutton" data-target="#courseCard{{$student->id}}">View Profile</button>
                                            <div class="popup">
                                                <div class="innerpop py-5 px-3">
                                                    <h4 class=" color-white text-capitalize text-center four-lines">
                                                        studnet profile
                                                    ...
                                                    <ul class="list-unstyled list-group mt-5">
                                                        <li class="text-capitalize mb-4"><span class="data-title">studnet name :</span><span class="data-content color1">{{$student->user->name}}</span></li>
                                                        <li class="text-capitalize mb-4"><span class="data-title">number of courses :</span><span class="data-content color1">{{count($student->reservations)}}</span></li>
                                                        <li class="text-capitalize mb-4"><span class="data-title">review number :</span><span class="data-content color1">100</span></li>
                                                        <li class="text-capitalize mb-4"><span class="data-title">student country :</span><span class="data-content color1">{{$student->user->nationality}}</span></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <form action="{{route('student_destroy',$student->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button class="course-uns-bt regect">Delete Acount</button>
                                            </form>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <p class="card-text text-capitalize">{{$student->user->name}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
